...
const STRATEGY_DESCRIPTIONS: Record<string, string> = {
    leek: "每支买入 $50,000 底仓；价格较上次成交价上涨 > 5% 时追高买入 $50,000；下跌 > 5% 时全部清仓。单日限制一次操作。",
    
    gambler: "每支买入 $10,000 底仓；价格较上次买入价下跌 > 10% 时，以当前持仓成本同等金额加倍补仓；上涨 > 2%（相对均价）时全部止盈。单日限制一次操作。",
    
    mom: "每支买入 $200,000 满仓；价格较上次买入价上涨 > 20% 时卖出 20% 仓位取现；下跌 > 5% 时全部止损。单日限制一次操作。",
    
    dog: "保留 $800,000 现金底线；单股买入 $40,000；价格较上次成交价上涨 > 5% 卖出一半；下跌 > 2% 迅速清仓。单日限制一次操作。",
    
    xiaoqing: "每支买入 $100,000 底仓；价格较上次成交价下跌 > 15% 时坚定加仓 $50,000；永不卖出。单日限制一次操作。",
    
    soldier: "每支买入 $100,000 底仓；相对上次成交价下跌 2% 补给 $10,000，上涨 2% 撤退 20%；总资产回撤 > 10% 时停止买入。单日限制一次操作。",
    
    zen: "每支买入 $100,000 底仓；每 24 小时触发一次随机决策：50% 概率买入 $50,000，50% 概率卖出 $50,000，全凭缘分。"
};
